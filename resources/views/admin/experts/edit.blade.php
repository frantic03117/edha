        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-12 mb-3 text-end">
                    <a href="{{route('experts.index')}}" class="btn btn-primary">Back</a>
                </div>
                <div class="col-md-12 ">
                    <div class="card card-body  shadow-success">
                        <form id="fill_details_form" action="{{ route('expert_update.admin', $expert['id']) }}"
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <select name="mode[]" multiple id="mode" class="form-select">
                                    ...
                                    <option value="Video" @selected(in_array('Online', $modes))>Online</option>
                                    <option value="Audio" @selected(in_array('Offline', $modes))>Offline</option>
                                </select>
                                <script>
                                    $("#mode").select2({
                                        closeOnSelect: false,
