    ...
    <form action="{{ route('find_expert.store') }}" id="findExpertForm" method="post">
        ...
        <div class="w-100 hiddenrows" id="question5">
            ...
            <div class="stickty-bottom w-100 start-0 bottom-0">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <button type="button" onclick="previousQuestion('question3', 'question5')"
                            class="btn btn-outline-warning rounded-pill w-100">
                            Previous
                        </button>
                    </div>
        ...
        <div class="w-100 hiddenrows" id="question7">
            ...
            <div class="w-100 input-group-question mb-4">
                ...
                @endforeach
                <div class="col-md-6 mb-3">
                    <button type="button" onclick="previousQuestion('question6', 'question7')"
                        class="btn btn-outline-warning rounded-pill w-100">
                        Previous
                    </button>
                </div>
        ...
        <div class="w-100 hiddenrows" id="question8">
            ...
            <div class="w-100 input-group-question mb-4">
                ...
                @endforeach
                <div class="col-md-6 mb-3">
                    <button type="button" onclick="previousQuestion('question7', 'question8')"
                        class="btn btn-outline-warning rounded-pill w-100">
                        Previous
                    </button>
                </div>
        ...
        <div class="w-100 hiddenrows" id="question9">
            ...
            <div class="stickty-bottom w-100 start-0 bottom-0">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <button type="button" onclick="previousQuestion('question8', 'question9')"
                            class="btn btn-outline-warning rounded-pill w-100">
                            Previous
                        </button>
                    </div>
            ...
            <div class="w-100">
                ...
                <div class="w-100" id="mobileBox" style="display: none;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" onkeydown="enterMobile(event)" id="mymobile" minlength="10"
