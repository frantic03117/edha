...
@section('content')
    ...
    <section class="space">
        <div class="container">
            ...
            <div class="row align-items-center" dta-aos="fade-up">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-12">
                            <a href="https://youtu.be/dQEtltBsxwc " target="_blank">
                                <div
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">You do not produce anger, you become angry. You seem to have lost
                                    ...
                                    counseling. Connect with a Psychologist.</p>
                            </div>
            ...
            <div class="col-md-12">
                <div class="w-100 d-block my-3" align = "center">
                    <a href="{{ url('find-expert') }}"
                        ...
                        Connect with Experts <img src="{{ url('public') }}/assets/img/bnt-arrow.svg" alt=""
                            class="img-fluid">
