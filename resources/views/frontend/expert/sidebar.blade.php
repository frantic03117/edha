    ...
    <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li>
            <a href="{{ route('leads')}}"
                ...
                <i class="fi fi-ts-calendar-clock"></i>
                Leads <small>Requested a Call back </small>
            </a>
        </li>
        <li>
            <a href="{{ route('unconfirm-leads')}}"
                class="nav-link @if (Route::currentRouteName() == 'unconfirm-leads') active box-shadow-3 @endif ">
                <i class="fi fi-ts-calendar-clock"></i>
                Leads <small>*</small>
            </a>
        </li>
        ...
        <li class="nav-item">
            <a href="{{ route('account_close') }}" class="nav-link @if (Route::currentRouteName() == 'account_close') active @endif"
                aria-current="page">
                <i class="fi fi-ts-user-pen"></i>
                Close Account
            </a>
