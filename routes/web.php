...
Route::prefix('admin')->middleware(['auth', 'isAdmin'])->group(function () {
    ...
    Route::resource('subscription', PlanController::class);
    Route::resource('postname', PostController::class);
    ...
    Route::post('add_points', [AdminController::class, 'add_points'])->name('add_points');
});
...
Route::prefix('ajax')->middleware('auth')->group(function () {
    ...
    Route::post('/discard_lead', [ExpertController::class, 'discard_lead'])->name('discard_lead');
});
Route::prefix('ajax')->group(function () {
    ...
    Route::post('get_posts', [AjaxController::class, 'get_posts'])->name('get_posts');
    ...
    Route::post('get_sub_category', [AjaxController::class, 'get_sub_category'])->name('get_sub_category');
});
